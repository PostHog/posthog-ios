...
//
    ...
    @Suite("PostHogWebP Tests")
    struct PostHogWebPTest {
        @Test("correctly encodes WebP image with -q 0.80")
        func correctlyEncodesWebPImageWithQ080() throws {
        ...
        func correctlyEncodesWebPImageWithQ030() throws {
            let bundle = Bundle.test
        ...
        func correctlyEncodesWebPImageWithAlpha() throws {
            let bundle = Bundle.test
