...
#ifndef POSTHOGRECORDER_SWIFT_H
#define POSTHOGRECORDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PostHogRecorder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15PostHogRecorder15PostHogRecorder")
@interface PostHogRecorder : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) PostHogRecorder * _Nonnull shared;)
+ (PostHogRecorder * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic) BOOL screenRecordingEnabled;
@property (nonatomic) BOOL logRecordingEnabled;
@property (nonatomic) BOOL networkRecordingEnabled;
