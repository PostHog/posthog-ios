...
buildExamplesPlatforms:
	...
	set -o pipefail && xcrun xcodebuild clean build -scheme PostHogExampleVisionOS -destination 'platform=visionOS Simulator,name=Apple Vision Pro' -verbose #visionOS
