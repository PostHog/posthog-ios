...
class PickerViewController: UIViewController {
    ...
    enum ColorComponent: Int {
        ...
        static var count: Int {
            ColorComponent.blue.rawValue + 1
        }
    }
...
extension PickerViewController: UIPickerViewDataSource {
    func numberOfComponents(in _: UIPickerView) -> Int {
        ColorComponent.count
    }

    func pickerView(_: UIPickerView, numberOfRowsInComponent _: Int) -> Int {
        numberOfColorValuesPerComponent
    }
}
...
extension PickerViewController: UIPickerViewAccessibilityDelegate {
    func pickerView(_: UIPickerView, accessibilityLabelForComponent component: Int) -> String? {
        switch ColorComponent(rawValue: component)! {
        case .red:
