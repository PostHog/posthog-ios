...
class PostHogUtilTests: QuickSpec {
  override func spec() {
    ...
    describe("JSON traverse", {
      ...
      it("works with strings") {
        expect(PHGUtils.traverseJSON("a b foo c", andReplaceWithFilters: filters) as? String) == "a b foo-bar c"
      }

      it("works recursively") {
        expect(PHGUtils.traverseJSON("a b foo foo c", andReplaceWithFilters: filters) as? String) == "a b foo-bar foo-bar c"
      }
      ...
      it("works with nested dictionaries") {
        ...
        guard let input = PHGUtils.traverseJSON(data, andReplaceWithFilters: filters) as? [String: Any] else {
      ...
      it("works with nested arrays") {
        ...
        let input = PHGUtils.traverseJSON(data, andReplaceWithFilters: filters)
        let output = [
